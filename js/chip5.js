...
//        while (tick++ < 66653 /* 4MHz */) {
  ...
  Interpreter.prototype.reset = function() {
    ...
    // font
    this.ram[0x0110] = 0xf0;
    this.ram[0x0111] = 0x80;
    this.ram[0x0112] = 0xf0;
    this.ram[0x0113] = 0x80;
    this.ram[0x0114] = 0xf0;
    this.ram[0x0115] = 0x80;
    this.ram[0x0116] = 0x80;
    this.ram[0x0117] = 0x80;
    this.ram[0x0118] = 0xf0;
    this.ram[0x0119] = 0x50;
    this.ram[0x011a] = 0x70;
    this.ram[0x011b] = 0x50;
    this.ram[0x011c] = 0xf0;
    this.ram[0x011d] = 0x50;
    this.ram[0x011e] = 0x50;
    this.ram[0x011f] = 0x50;
    this.ram[0x0120] = 0xf0;
    this.ram[0x0121] = 0x80;
    this.ram[0x0122] = 0xf0;
    this.ram[0x0123] = 0x10;
    this.ram[0x0124] = 0xf0;
    this.ram[0x0125] = 0x80;
    this.ram[0x0126] = 0xf0;
    this.ram[0x0127] = 0x90;
    this.ram[0x0128] = 0xf0;
    this.ram[0x0129] = 0x90;
    this.ram[0x012a] = 0xf0;
    this.ram[0x012b] = 0x10;
    this.ram[0x012c] = 0xf0;
    this.ram[0x012d] = 0x10;
    this.ram[0x012e] = 0xf0;
    this.ram[0x012f] = 0x90;
    this.ram[0x0130] = 0xf0;
    this.ram[0x0131] = 0x90;
    this.ram[0x0132] = 0x90;
    this.ram[0x0133] = 0x90;
    this.ram[0x0134] = 0xf0;
    this.ram[0x0135] = 0x10;
    this.ram[0x0136] = 0x10;
    this.ram[0x0137] = 0x10;
    this.ram[0x0138] = 0x10;
    this.ram[0x0139] = 0x60;
    this.ram[0x013a] = 0x20;
    this.ram[0x013b] = 0x20;
    this.ram[0x013c] = 0x20;
    this.ram[0x013d] = 0x70;
    this.ram[0x013e] = 0xa0;
    this.ram[0x013f] = 0xa0;
    this.ram[0x0140] = 0xf0;
    this.ram[0x0141] = 0x20;
    this.ram[0x0142] = 0x20;
